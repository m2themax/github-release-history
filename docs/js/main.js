...
function getGraphData() {
	...
	$.getJSON(url, function(resp) {
		...
		$.getJSON(url, function(blob) {
			...
			html += "<p>&nbsp</p><p><i>Just show me an <a href='index.html?username=ramboxapp&repository=community-edition'>example</a>!</i></p></div>";
			var resultDiv = $("#stats-result");
			resultDiv.hide();
			resultDiv.html(html);
			resultDiv.slideDown();
			...
			if (jqXHR.status == 404) {
				...
				html += "<p><i>Just show me an <a href='index.html?username=ramboxapp&repository=community-edition'>example</a>!</i></p></div>";
			}
