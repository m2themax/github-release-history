...
function getGraphData() {
	...
	//var url = apiRoot + "repos/m2themax/github-release-history/contents/data/" + user + "/" + repository + ".json";
	var url = "https://raw.githubusercontent.com/m2themax/github-release-history/master/data/" + user + "/" + repository + ".json";
	//console.log(url)
	$.getJSON(url, function(resp) {
		...
		$.getJSON(url, function(blob) {
			...
			html += "<p>&nbsp</p><p><i>Just show me an <a href='index.html?username=m2themax&repository=community-edition'>example</a>!</i></p></div>";
			var resultDiv = $("#stats-result");
			resultDiv.hide();
			resultDiv.html(html);
			resultDiv.slideDown();
			...
			if (jqXHR.status == 404) {
				...
				html += "<p><i>Just show me an <a href='index.html?username=m2themax&repository=community-edition'>example</a>!</i></p></div>";
			}
